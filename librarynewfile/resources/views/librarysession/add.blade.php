    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form method = "POST" action="{{ route('librarysession-store') }}">
                     ...
                     <div>  
                       <select class="text-black font-bold" style="text-align:center" style="text-align:center" name="xsno">
                    ...
                    <div>
                    <input class="text-black font-bold" style="text-align:center"  type="text"  name="xstudentpurpose" value="{{old('xstudentpurpose')}}"/>
                    </div>
</div>
                    <div class="flex-items-center" style="text-align:center"><label for="Student Session">Student Session</label>
                    <div>
                    <input class="text-black font-bold" style="text-align:center"  type="text"  name="xstudentsession" value="{{old('xstudentsession')}}"/>
                    </div>
</div>
